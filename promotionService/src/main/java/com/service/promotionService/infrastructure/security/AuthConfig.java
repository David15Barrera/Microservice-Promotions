package com.service.promotionService.infrastructure.security;

import com.service.promotionService.infrastructure.property.RsaProperty;
...
//                .cors(c -> c.disable())
                ...
                .authorizeHttpRequests(a -> a
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/error", "/api/v1/promotions/**", "/api/promotion/**").permitAll()
